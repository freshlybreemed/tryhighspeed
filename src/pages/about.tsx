...
const ProductPage = () => (
  <App>
    <Layout>
      <SEO title="About" />
      <main
        className="h-full sm:hidden flex items-center py-40 lg:py-48 xl:py-60 pl-10 pr-30 bg-purple-900 text-white relative"
        style={{
          backgroundImage:
            "url('https://i2.wp.com/tryhighspeed.com/wp-content/uploads/2019/05/DSC00294.jpg')",
      ...
      <div className="mx-5 text-xl">
        ...
        <p className="my-2 py-2 leading-8">
          ...
          talent, to a full fledged juice outfit geared to set foot in every
          major city, to Book Drives for the youth, HighSpeed is determined to
          establish a new frontier. We pride ourselves on being innovators in
          spaces that have been limited for years!
        </p>
